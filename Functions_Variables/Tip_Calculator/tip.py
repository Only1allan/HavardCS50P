"""
Write a function that takes users meal and the percentage they would like to leave as a tip and return the tip they should pay
...
def dollars_to_float(d):
    precise_dollar = d.replace("$", "")
    return float(precise_dollar)


def percent_to_float(p):
     precise_percent = p.replace("%", "")
     return float(precise_percent)/100
